...
import com.example.crudrealtime090125.adapters.AgendaAdapter
import com.example.crudrealtime090125.databinding.ActivityPrincipalBinding
import com.example.crudrealtime090125.models.Agenda
import com.example.crudrealtime090125.providers.AgendaProvider
...
class PrincipalActivity : AppCompatActivity() {
    ...
    var adapter=AgendaAdapter(mutableListOf<Agenda>(), {item->borrarItem(item)}, {item->editarItem(item)})
    ...
    private fun recuperarDatosAgenda() {
        val agendaProvider= AgendaProvider()
    ...
    //----------------------------------------------------------------------------------------------
    private fun borrarItem(item: Agenda){
        database.child(item.email.encodeEmail()).removeValue()
    ...
    private fun editarItem(item: Agenda){
